...
{ 
   ...
   std::cout<<"The game is won by you.";
    ...
    std::cout<<std::endl;
    std::cout<<"Using the min-max algorithm the computer was able to use the optimal move.\n Sample project that shows the simple AI and the brief";
    std::cout<<"use case of the min-max algorithm \n mainly used in the two player games.\n";
    std::cout<<"Happy coding ^_^";
}
